...
const locations = [
    'Maithan Dam','Bhatinda Fall', 'Shakti Mandir','The OZone Galleria'
    ,'Panchet Dam', 'Topchachi Wildlife Sanctuary', 'Birsa Munda Park','Shree Ram Plaza'
    ,'City Center','Bekar Bandh','I.S.M' ];
...
onload = function() {
    ...
    function createData()
    {
        ...
        for(let i=0; i<V; i++){
            ...
            edges.push({from:i, to:neigh, color: 'red', 
